...
* ---------- Stød 4.1a: produktivitetsstød i t5 ----------
* Reset theta igen
theta.fx(t) = 1;
theta.fx('t5') = 1.10;
...
C_t99_theta5.l = C.l('t99');
K_t99_theta5.l = K.l('t99');
Y_t99_theta5.l = Y.l('t99');
...
* ---------- Stød 4.1b: Tsunami (K0 -20%) ----------
* Tilbage til basisantagelser for theta, delta, osv.
theta.fx(t) = 1;


* Tsunami: kapital i t0 reduceres 20%
K.fx('t0') = 0.8*3400;
* de andre perioder er frie (eller initialiseres som før)
K.lo(t)    = 0;   

Solve Ramsey using CNS;

C_t99_tsunami.l = C.l('t99');
K_t99_tsunami.l = K.l('t99');
Y_t99_tsunami.l = Y.l('t99');
...
* ---------- Stød 4.1c: Afskrivningsrate falder 10% ----------
* Tilbage til basis-setup, men med lavere delta
theta.fx(t) = 1;
delta.fx(t) =delta.l(t)*0.9;   

Solve Ramsey using CNS;

    
C_t99_delta.l = C.l('t99');
K_t99_delta.l = K.l('t99');
Y_t99_delta.l = Y.l('t99');
